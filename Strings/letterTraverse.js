//write a function that accepts two parameters; one being a non-empty string of letters and the second being a key of an integer value.
//the key value should represent how many values each letter should shift by.
//for example 'abc', 2 => 'cde'
